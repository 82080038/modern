#!/usr/bin/env python3
"""
Yahoo Finance Data Fetcher Fixed
==================================
...
class YahooFinanceDataFetcherFixed:
    """Yahoo Finance Data Fetcher with Rate Limiter - Fixed Version"""
    ...
    def __init__(self, db_config: Dict[str, Any]):
        ...
        # Indonesian stock symbols (IDX) - Limited set for testing
        self.indonesian_stocks = [
            ...
            # Mining & Energy
            'ANTM.JK', 'ADRO.JK', 'PTBA.JK', 'PGAS.JK',
            
            # Consumer Goods
            'UNVR.JK', 'INDF.JK', 'ICBP.JK', 'GGRM.JK',
            
            # Property & Real Estate
            'BSDE.JK', 'CTRA.JK', 'LPPI.JK', 'SMRA.JK',
            
            # Automotive
            'ASII.JK', 'AUTO.JK', 'INCO.JK',
            
            # Infrastructure
            'ADHI.JK', 'WIKA.JK', 'JSMR.JK',
            
            # Healthcare
            'KLBF.JK', 'SIDO.JK',
            
            # Agriculture
            'AALI.JK', 'ADRO.JK', 'ANTM.JK', 'INCO.JK',
            
            # Finance
            'BTPN.JK', 'BJB.JK', 'BKSW.JK'
        ]
        
        # Remove duplicates and limit to 20 stocks for initial testing
        self.indonesian_stocks = list(set(self.indonesian_stocks))[:20]
    ...
    def fetch_all_indonesian_stocks(self) -> Dict[str, Any]:
        ...
        print("FETCHING INDONESIAN STOCK DATA - FIXED VERSION")
        print("=" * 80)
        ...
        results = {
            'test_type': 'yahoo_finance_data_fetch_fixed',
    ...
    def generate_fetch_report(self, results: Dict[str, Any]) -> None:
        ...
        print("\nYAHOO FINANCE DATA FETCH REPORT - FIXED VERSION")
        print("=" * 80)
        ...
        results_file = f"yahoo_finance_fetch_fixed_{timestamp}.json"
...
def main():
    ...
    fetcher = YahooFinanceDataFetcherFixed(db_config)
