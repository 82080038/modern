...
Sistem trading simulation menggunakan data real dari database MySQL scalper.
...
class DatabaseTradingSystem:
    """
    Database Trading System menggunakan data real dari MySQL database scalper
    """
    ...
    async def run_database_trading_simulation(self, 
                                            start_date: str = "2023-01-01", 
                                            end_date: str = "2024-12-31") -> Dict[str, Any]:
        """Run trading simulation menggunakan data dari database MySQL"""
        try:
            print("Starting Database Trading System...")
            print("=" * 60)
            ...
            # Step 3: Calculate portfolio allocation
            print("\nStep 3: Calculating Portfolio Allocation...")
            ...
            print("\n" + "=" * 60)
            print("Database Trading Simulation Completed!")
            print("=" * 60)
            
            return report
            
        except Exception as e:
            logger.error(f"Error in database trading simulation: {e}")
            return {'error': str(e)}
    ...
    async def _get_available_symbols(self) -> List[str]:
        ...
        try:
            ...
            # Query to get unique symbols from market_data table
    ...
    async def _calculate_portfolio_allocation(self, symbols: List[str], historical_data: Dict[str, pd.DataFrame]) -> Dict[str, float]:
        """Calculate optimal portfolio allocation using database data"""
        try:
            ...
            print("Portfolio allocation calculated from database data:")
    ...
    async def _run_trading_simulation(self, 
        ...
        """Run trading simulation using database data"""
        try:
            ...
            return {
                ...
                'data_source': 'MySQL Database (scalper)'
            }
    ...
    def _generate_recommendations(self, 
        ...
        try:
            ...
            if total_return > 0.2:  # 20% return
                recommendations.append("Excellent performance using real database data! Consider increasing position sizes.")
            elif total_return > 0.1:  # 10% return
                recommendations.append("Good performance with real market data. Current strategy is working well.")
            elif total_return > 0:  # Positive return
                recommendations.append("Positive returns achieved with real data. Consider optimizing strategy.")
            else:
                recommendations.append("Negative returns with real data. Review and adjust trading strategy.")
            
            recommendations.append("Using real database data provides more accurate simulation results.")
            recommendations.append("Database data ensures realistic market conditions and price movements.")
...
async def main():
    """Main function untuk menjalankan database trading simulation"""
    try:
        trading_system = DatabaseTradingSystem()
        
        # Run database trading simulation
        results = await trading_system.run_database_trading_simulation(
        ...
        # Display results
        print("\nDATABASE TRADING SIMULATION RESULTS:")
        print("=" * 60)
